...
<body style="color: gray">
	...
	<form:form action="${action}" method="post"
		commandName="managerRegisterForm" novalidate="true">
		<div class="content">
			<h4 style="text-align: center; padding: 10px 0 0 0">Manager
				Registration Form</h4>
			<div class="container"
				style="border: none; width: 45%; margin: 30px auto; padding: 10px 10px; background: white; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
				<%-- <div class="row">
