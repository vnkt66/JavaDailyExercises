...
<body style="box-sizing: border-box;">
	...
	<div class="content" style="margin-left: 450px">
		<h1 style="text-align: center; color: gray">Hi
			${adminName}(${adminId}), Your Pending Approvals</h1>
		<div class="container">
			<div class="row">
				<c:forEach var="plane" items="${planeList}">
					<div class="col-md-3"
						...
						<ul style="color: gray; list-style-type: none; padding: 0;">
							<li>Plane Id: ${plane.planeId}</li>
							<li>Hanger id: ${plane.getHanger().hangerId}</li>
							<li style="color: red">Status: Pending</li>
							<button class="btn btn-success" type="button"
								onclick="javascript:approveRequest(${plane.planeId})">Approve</button>
						</ul>
					</div>
				</c:forEach>
			</div>
