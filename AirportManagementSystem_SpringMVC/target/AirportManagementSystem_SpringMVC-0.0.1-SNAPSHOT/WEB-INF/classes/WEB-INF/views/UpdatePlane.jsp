...
<body style="color: gray">
   <jsp:include page="Header.jsp" />
	...
	<c:url var="action" value="/editPlane"></c:url>
	<form:form action="${action}" method="post" commandName="updatePlaneForm"
		novalidate="true">
		<div class="content">	
		<h4 style="text-align: center; padding: 5px 0 0 0">Update Plane</h4>
		<div class="container"
			...
			<div class="row">
				<div class="col-md-4">Plane Id:</div>
				<div class="col-md-8">
					<form:input path="planeId" style="width: 100%" readonly="true"/>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<form:input path="maxFuel" style="width: 100%" readonly="true"/>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">Kerosin Storage:</div>
				<div class="col-md-8">
					<form:input path="kerosinStorage" style="width: 100%" readonly="true"/>
				</div>
			</div>
