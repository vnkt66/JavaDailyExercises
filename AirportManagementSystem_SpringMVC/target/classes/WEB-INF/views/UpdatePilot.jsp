...
<body style="color: gray">
	...
	<form:form action="${action}" method="post"
		commandName="updatePilotForm" novalidate="true">
		<div class="content">
			<h4 style="text-align: center;">Update Pilot</h4>
			<div class="container"
				style="border: none; width: 40%; margin: 15px auto; padding: 20px 10px; background: white; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
				<div class="row">
